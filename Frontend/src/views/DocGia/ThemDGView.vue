<template>
  <div class="container mt-5">
    <h2 class="text-center mb-4">THÊM ĐỘC GIẢ MỚI</h2>
...
const bookFields = [
  ...
  { key: 'HoLot', label: 'Họ lót', type: 'text' }, // Có thể thay bằng select nếu có API danh sách NXB
  { key: 'Ten', label: 'Tên', type: 'text' }, // Có thể thay bằng select nếu có API danh sách danh mục
  // { key: 'ChucVu', label: 'Ngày sinh', type: 'date' },
  { key: 'SoDienThoai', label: 'Giới tính', type: 'number' },
  { key: 'SoDienThoaFi', label: 'SĐT', type: 'number' },
  { key: 'DiaChi', label: 'Địa chỉ', type: 'number' },
];
