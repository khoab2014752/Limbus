<template>
  <div class="container mt-5">
    <h2 class="text-center mb-4">THÊM NHÀ XUÂT BẢN</h2>
...
const bookFields = [
  { key: 'TenNXB', label: 'Tên nhà xuất bản', type: 'text' },
  { key: 'DiChi', label: 'Địa chỉ', type: 'text' }, // Có thể thay bằng select nếu có API danh sách NXB
];
